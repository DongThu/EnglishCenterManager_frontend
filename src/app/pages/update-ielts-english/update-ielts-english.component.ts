...
@Component({
  selector: 'app-update-ielts-english',
  templateUrl: './update-ielts-english.component.html',
  styleUrls: ['./update-ielts-english.component.css']
})
export class UpdateIeltsEnglishComponent implements OnInit {
