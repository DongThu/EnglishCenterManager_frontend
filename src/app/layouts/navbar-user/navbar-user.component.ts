...
export class NavbarUserComponent implements OnInit{
  ...
  allowedRoutes = ['/home-user', '/about', '/contact','/child-schedule', '/young-schedule','/ielts-schedule', '/toiec-schedule','/basic-schedule','/child-english','/young-english', '/ielts','/toiec', '/basic-english','/login-user', '/register', '/quiz-app', '/quiz-app-result'];
